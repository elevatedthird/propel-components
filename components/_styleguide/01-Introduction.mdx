...
## Getting Started
- Install the [propel module](https://github.com/elevatedthird/paragon_propel), which provides a drush command to add an SDC to your theme's `components` directory
...
### 02-blocks
Contains components that are composed of multiple composites.

### 03-formations
Contains wrappers for layouts
