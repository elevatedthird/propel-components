...
[Github Repo](https://github.com/elevatedthird/propel-components)
...
- Kinetic theme installed (>=2.0.0)

## Getting Started

- Install the [propel module](https://github.com/elevatedthird/propel_drush), which provides a drush command to add an SDC to Kinetic's `components` directory
- run `drush propel:init`
...
Contains templates for entire pages and content types.
