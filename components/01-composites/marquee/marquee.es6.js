  ...
  attach(context) {
    ...
    marquees.forEach((e) => {
      ...
      const containerSize = direction === 'horizontal'
        ? e.scrollWidth
        : e.scrollHeight;
      const itemsSize = direction === 'horizontal'
        ? items.offsetWidth
        : items.offsetHeight;
      ...
      console.log(containerSize, itemsSize, numClones, items.getBoundingClientRect().width);
      // Web animations.
      ...
      const keyFrames = [
        ...
        { transform: direction === 'horizontal' ? `translateX(${-trackLength/2}px)` : `translateY(${-trackLength/2}px)` }
      ];
