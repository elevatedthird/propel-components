...
export default {
  ...
  argTypes: {"heading":{"control":{"type":"text"},"type":{"required":false,"name":""},"table":{"type":{"summary":"text"}}},"eyebrow":{"control":{"type":"text"},"type":{"required":false,"name":""},"table":{"type":{"summary":"text"}}},"eyebrow_h1":{"control":{"type":"boolean"},"type":{"required":false,"name":""},"table":{"type":{"summary":"boolean"}}}},
