...
class TabsAutomatic {
  constructor(groupNode) {
    ...
    this.tabpanels = Array.from(this.tablistNode.querySelectorAll('[role=tabpanel]'));

    if (this.tabs.length !== this.tabpanels.length) {
      console.error('TabsAutomatic: The number of tabs and tabpanels must be the same.');
      return;
    }
