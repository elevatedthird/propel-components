...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "A bootstrap accordion. Providing a trigger and a accordion.",
      },
      source: {
  ...
  argTypes: {
    open: {
      ...
      description: "Check if the first item should be opened by default.",
      table: { type: { summary: "boolean" } },
    },
    allow_multiple: {
      control: { type: "boolean" },
      type: { required: false, name: "" },
      description: "Check if multiple items can be opened at the same time.",
      table: { type: { summary: "boolean" } },
    },
  },
  component: accordion,
