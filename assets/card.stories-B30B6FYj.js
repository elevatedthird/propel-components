import{t as u,D as y,T as n,a as m}from"./twig-TIIEE6v_.js";import"./_commonjsHelpers-_d1bhYXs.js";const g=function(o){const e={"kinetic:badge":"./components/00-elements/badge/badge.twig","kinetic:title":"./components/01-composites/title/title.twig"};o.extendFunction("include",(s,l)=>{const i=e[s];if(!i)throw new Error(`Template ${s} not found`);return o.twig({id:s,href:i,async:!1}).render(l)})};g(n);const v=t=>t.extendFilter("clean_unique_id",()=>o=>o.split(" ").reverse().join(" "));v(n);m(n);n.cache(!1);const r=t=>t,w=(t={})=>{const o=u.twig({id:"/home/runner/work/propel-components/propel-components/components/01-composites/card/card.twig",data:[{type:"raw",value:"<div ",position:{start:0,end:5}},{type:"output",position:{start:5,end:21},stack:[{type:"Twig.expression.type.variable",value:"attributes",match:["attributes"],position:{start:5,end:21}}]},{type:"raw",value:`>
  <div class="card">
...
`,position:{start:451,end:451}}],precompiled:!0});o.options.allowInlineIncludes=!0;try{let e=t.defaultAttributes?t.defaultAttributes:[];return Array.isArray(e)||(e=Object.entries(e)),r(o.render({attributes:new y(e),...t}))}catch(e){return r("An error occurred whilst rendering /home/runner/work/propel-components/propel-components/components/01-composites/card/card.twig: "+e.toString())}},f={title:"01-composites/card",tags:["autodocs"],parameters:{docs:{description:{component:"A single card."},source:{code:"drush propel:add card"}}},argTypes:{heading:{control:{type:"text"},type:{required:!1,name:""},table:{type:{summary:"text"}}}},component:w},a={args:{heading:""}};var p,d,c;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    heading: ""
  }
}`,...(c=(d=a.parameters)==null?void 0:d.docs)==null?void 0:c.source}}};const k=["Default"];export{a as Default,k as __namedExportsOrder,f as default};
